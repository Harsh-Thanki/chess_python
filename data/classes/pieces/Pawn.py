...
class Pawn(Piece):
	def __init__(self, pos, color, board):
		...
		# Load and scale the image for the pawn
	...
	def get_possible_moves(self, board):
		...
		# Determine the possible moves based on the pawn's color
		if self.color == 'white':
			moves.append((0, -1))
		...
		# Calculate the new positions and add the corresponding squares to the output list
		for move in moves:
	...
	def attacking_squares(self, board):
		# Get all moves and filter out the non-diagonal ones
